...
export default function AIMentor() {
    const chatMessages = [
        {
            type: 'user',
            text: 'Comment puis-je améliorer ce prompt : "Donne moi des idées" ?',
            delay: 0.3,
        },
        {
            type: 'ai',
        ...
        {
            type: 'user',
            text: 'Merci ! Quelles autres techniques puis-je utiliser ?',
            delay: 1.6,
        },
    ];
            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <FadeIn direction="left">
                        <div>
                            <motion.div
                                className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-500/10 border border-violet-500/20 text-xs text-violet-400 mb-6"
                            ...
                            <StaggerContainer className="space-y-4" staggerDelay={0.15} delayChildren={0.2}>
                        ...
                        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden">
                            ...
                            <div className="flex items-center gap-3 px-4 py-3 border-b border-zinc-800">
                                <motion.div
                                    ...
                                    animate={{ boxShadow: ['0 0 0px rgba(139,92,246,0)', '0 0 15px rgba(139,92,246,0.4)', '0 0 0px rgba(139,92,246,0)'] }}
                            ...
                            <div className="p-4 space-y-4 h-80 overflow-y-auto">
                                ...
                                >
                                    <div className="bg-zinc-800 rounded-2xl rounded-bl-md px-4 py-3 max-w-sm">
                                        ...
                                        <motion.div
                                            className="bg-zinc-900 rounded-lg p-3 mb-3"
                            ...
                            <div className="p-4 border-t border-zinc-800">
                                <div className="flex items-center gap-3">
                                    ...
                                    />
                                    <motion.button
                                        className="w-10 h-10 bg-violet-600 hover:bg-violet-500 rounded-lg flex items-center justify-center transition-colors"
