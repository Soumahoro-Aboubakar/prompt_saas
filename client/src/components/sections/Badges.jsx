...
function BadgeCard({ badge }) {
    ...
    return (
        <div className="flex flex-col items-center p-4 bg-zinc-800/30 rounded-xl border border-zinc-700/50">
            <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${badge.gradient} flex items-center justify-center mb-3 shadow-lg ${badge.shadow}`}>
